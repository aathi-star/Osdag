...
# Import ColumnDesign conditionally to avoid startup errors if plugin is not installed
try:
    from ..data.osdag_plugins.plugins.osdag_column.column_plugin.column.Column import ColumnDesign
except ImportError:
    # Create a placeholder that will be replaced at runtime when needed
    ColumnDesign = None
