...
class PluginManager:
    ...
    def load_plugins(self):
        ...
        self.plugins.clear()  # Clear existing plugins before loading
    ...
    def _load_from_entry_points(self):
        try:
            ...
            # Try using pkg_resources (more compatible with different Python versions)
            try:
            ...
            try:
                ...
                if isinstance(all_entry_points, dict):
                    ...
                    # Newer Python versions return an object with select method
                    try:
                        osdag_plugins = all_entry_points.select(group='osdag.plugins')
                    except AttributeError:
                        # Handle case where entry_points() returns a list of EntryPoint objects
                        osdag_plugins = []
                        for ep in all_entry_points:
                            try:
                                ...
                                pass  # Skip entry points that can't be processed
        ...
        try:
            ...
            if spec and spec.loader:
                ...
                if plugin_class:
                    try:
                        plugin_instance = plugin_class()
                        # Set initial state to inactive - do not auto-activate
                        plugin_instance.is_active = False
                        
                        # Additional validation to ensure this is a proper plugin
